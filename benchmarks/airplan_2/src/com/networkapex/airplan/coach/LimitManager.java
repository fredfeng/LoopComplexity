...
public class LimitManager extends AirManager {
    ...
    // Jia: Added static convenience method
    public static String pullContentsPublic(RouteMap routeMap, Airport origin, Airport dest, FlightWeightType weightType, String weightLabel) throws AirRaiser {
        GraphTranslator graphTranslator = new GraphTranslator(routeMap, weightType);
    ...
    // Jia: changed this method to static
    private static void fetchContentsGateKeeper(Map<String, String> contentsDictionary) {
