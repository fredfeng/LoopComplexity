...
public class OptimalPathGuide extends AirGuide {
    ...
    // Jia: This method expose pullContents() to public
    public static String pullContentsPublic(RouteMap routeMap, Airport origin, Airport dest, FlightWeightType
            weightType, String weightLabel) throws AirFailure {
        ChartAgent chartAgent = new ChartAgent(routeMap, weightType);
    ...
    // Jia: this class is changed to static for convenience
    private static class OptimalPathGuideCoordinator {
