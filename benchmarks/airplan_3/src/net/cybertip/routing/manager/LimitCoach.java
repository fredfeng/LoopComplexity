...
public class LimitCoach extends AirCoach {
    ...
    public static String grabContentsPublic(RouteMap routeMap, Airport origin, Airport dest, FlightWeightType weightType, String weightLabel) throws AirTrouble {
        GraphDelegate graphDelegate = new GraphDelegate(routeMap, weightType);
    ...
    private static void takeContentsHelp(Map<String, String> contentsDictionary) {
